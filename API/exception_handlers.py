...
def csrf_exception_handler(request: fastapi.Request, exception: fastapi_csrf_protect.exceptions.CsrfProtectError):
...
def invalid_payment_credentials_handler(request: fastapi.Request, exception: api_exceptions.EmptyPaymentCredentials):
